...
# SPDX-FileCopyrightText: Copyright 2006-2008 Red Hat, Inc.
# SPDX-FileCopyrightText: Michael DeHaan <mdehaan@redhat.com>
...
# SPDX-FileCopyrightText: Simplified for use as library by koan, Michael DeHaan <mdehaan@redhat.com>
