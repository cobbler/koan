...
def run_cmd(cmd, shell=False):
    ...
    @param shell bool use a Linux shell
    @return str output
...
def is_local_file(file_location):
    ...
    @param file_location str file URL/path
...
def download_file(file_url):
    ...
    @param file_url virtinstall file URL
...
def create_kvm_guest(guest_name, num_virtual_cpus, virtual_ram, virtual_disk_size,
    ...
    @param num_virtual_cpus int number of virtual CPUs in guest
    @param virtual_ram int amount of virtual RAM in MB in guest
    @param virtual_disk_size int virtual disk size in GB in guest
    @param os str name and version of Linux OS to be installed in guest
    @param os_iso_path str ISO path of Linux OS to be installed in guest.
            This parameter and os_tree_location are mutually exclusive.
    @param os_tree_location str path/URL of Linux OS tree
            This parameter and os_iso_path are mutually exclusive.
    @param autoinstall_file_location str path/URL of automatic installation file
            (autoyast / kickstart / preseed). This parameter and os_tree_location
             must be used together
    @param kernel_args str extra kernel command line arguments
